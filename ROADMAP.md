...
Observed browser use may justify later versioned objectives for:

- broader editing surfaces;
- interaction refinements;
- distribution and store publication;
- release automation;
- commercial capabilities;
- a native runtime.

Each future objective supplies a present requirement, its smallest sufficient architecture, explicit acceptance, and its own evidence. It inherits no placeholder or speculative mechanism from V0.1.

## Deferred boundary

The current Deferred set remains the one defined by [SPEC.md](SPEC.md) and [docs/ENGINEERING.md](docs/ENGINEERING.md). This roadmap creates no present product, architecture, asset, release, or support requirement.
