...
> **Status:** Proposed logo-only successor specification  
> **Source baseline:** Emenda Brand System v2.0.2  
> **Purpose:** Define one minimal, coherent Emenda logo system across favicon, browser extension, app icon, wordmark, print, motion, light mode, dark mode, and future product surfaces.
...
This document is a proposed logo-system successor to the logo-specific provisions of the frozen Emenda Brand System v2.0.2.

Adopting the new logo as repository authority requires the next versioned documentation freeze in accordance with Emenda governance. Until that approval, `BRAND.md` v2.0.2 remains the frozen repository authority.
